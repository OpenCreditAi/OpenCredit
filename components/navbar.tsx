        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex items-center'>
            <Link href={`/${userType}/dashboard`} className='flex items-center'>
              <div className='w-10 h-10 rounded-full bg-gradient-to-br from-purple-600 to-purple-800 flex items-center justify-center text-white font-bold text-xl ml-1'>
                OC
              </div>
              <span className='text-xl font-bold text-purple-800 hidden sm:inline-block'>
                OpenCredit
              </span>
            </Link>
          </div>
          ...
          <div className='flex items-center space-x-4 space-x-reverse'>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant='ghost' size='icon' className='relative pt-1'>
                ...
                <div className='max-h-[300px] overflow-y-auto'>
                  <div className='p-3 hover:bg-gray-50 border-b'>
                    <p className='font-medium text-sm'>
                      בקשת הלוואה חדשה התקבלה
                    </p>
                    <p className='text-xs text-gray-500'>לפני 5 דקות</p>
                  </div>
                  <div className='p-3 hover:bg-gray-50 border-b'>
                    <p className='font-medium text-sm'>
                      מסמך חדש הועלה לבקשה #1002
                    </p>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  <Avatar>
                    <AvatarImage
                      src='/profile.svg?height=40&width=40'
                      alt='User'
                    />
