...
export default function FinancierDashboard() {
  ...
  return (
    <div>
      <h1 className="text-4xl font-bold mb-8 text-purple-800 text-center">עמוד ניהול - מממן</h1>
      ...
      <Tabs defaultValue="all" className="mb-6">
        ...
        <TabsContent value="processing">
          <div className="bg-white shadow-md rounded-lg p-6 text-center">
            <p className="text-gray-600">מציג בקשות בטיפול בלבד</p>
          </div>
        </TabsContent>

        <TabsContent value="offered">
          <div className="bg-white shadow-md rounded-lg p-6 text-center">
            <p className="text-gray-600">מציג הצעות שהוגשו בלבד</p>
          </div>
        </TabsContent>
      </Tabs>
    </div>
